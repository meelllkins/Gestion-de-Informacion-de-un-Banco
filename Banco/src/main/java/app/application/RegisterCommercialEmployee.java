...
@Service
public class RegisterCommercialEmployee {

    private final IUserPort userPort;
    private final PasswordEncoder passwordEncoder;

    public RegisterCommercialEmployee(IUserPort userPort, PasswordEncoder passwordEncoder) {
    ...
    public User register(User employee, String username, String password) {
        ...
        employee.setSystemRole(SystemRole.COMMERCIAL_EMPLOYEE);
